...
public class PostgreSqlExecutionEngine : IExecutionEngine
{
        ...
        CancellationToken ct)
    {
        ...
        var statements = SqlExecutionEngine.SplitStatements(script, DatabaseDialect.PostgreSQL);
        ...
        CancellationToken ct)
    {
        ...
        catch (PostgresException ex)
        {
            ...
            return new StatementResult
            {
                ...
                Statement = TruncateStatement(statement),
                Success = false,
                ErrorMessage = $"{ex.MessageText} (Code: {ex.SqlState})",
                Duration = sw.Elapsed
            };
        }
        catch (Exception ex)
